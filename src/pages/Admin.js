...
function Admin() {
  ...
  const postdata = async (e) => {
    ...
    await message.success('Thank you for registration', 1);
  ...
  const becomeaAmbrassador = async (e) => {
    ...
    await fetch("https://elegant-singlet-jay.cyclic.app/ambassador", requestOptions)
      .then(response => setotpform("thankyou"))
        ...
        <div className='register' >
                ...
                <tbody><tr>
                  <td>
                    <div style={{ marginBottom: "50px" }}>An OTP has been sent to your email.
                      <p style={{ fontSize: '45%', margin: "2px" }}>If you haven't got the OTP please check you entered the correct email address.</p>
                    </div>
                  </td>
          ...
          {otpform === "4" && <>
            ...
            >
              ...
              <div className='confirmTicket' style={{ justifyContent: "center" }}>
                ...
                <div style={{ width: '96%', color: 'red', display: 'flex', justifyContent: "flex-end", paddingRight: '4%' }}><a className='editlink' onClick={() => setotpform("1")}> <AiFillEdit /> Edit</a>
                </div>
              </div>
          ...
          {otpform === "5" && <>
            ...
            <form className='form1' onSubmit={becomeaAmbrassador}>
              ...
              <div style={{ fontSize: '50%', textAlign: "left", marginTop: '15px' }}>upload Your Profile Picture</div>
